...
public class SendToStepperDialog extends JDialog {
    ...
    public class SequenceListEntry implements ListEntry {
        ...
        public SequenceListEntry(StepSequence sequence) {
    ...
    class SequenceListModel implements ListModel<ListEntry> {
        ...
        public SequenceListModel(List<StepSequence> sequences) {
            this.listeners = new HashSet<>();
            this.entries = sequences.stream().map((StepSequence sequence) -> new SequenceListEntry(sequence)).toList();
    ...
    public class SendResult implements Result {
        ...
        public SendResult(StepSequence sequence) {
            this.sequence = sequence;
        }
    ...
    public Result prompt() {
        ...
        this.listModel = new SequenceListModel(sequenceManager.getSequences());
        ...
        actionMap.put("CreateNew", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                List<StepSequence> sequences = Stepper.getSequenceManager().getSequences();
                boolean sequenceAlreadyExists = sequences.stream().anyMatch((StepSequence sequence) -> sequence.getTitle().equals(name));
